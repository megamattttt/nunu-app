...
export const FEED0: FeedPost[] = [
  { id:'f1', who:'lea', name:'Léa Fontaine', when:'il y a 40 min', tag:'COUTURE', tagC:'#E2685A',
  ...
  { id:'f2', who:'karim', name:'Karim Belhadj', when:'il y a 2 h', tag:'COURSE', tagC:'#93C169',
    text:'Fractionné du mardi tenu jusqu’au bout. Neuvième jour d’affilée.', px:'+35 PX',
    likes:8, liked:false, comments:[] },
  { id:'f3', who:'ines', name:'Inès Moreau', when:'hier', tag:'CUISINE', tagC:'#E8B863',
